...
public class UI {
	...
	public static ChessPosition readChessPosition(Scanner entrada) {
		try {
			...
			throw new InputMismatchException("Error reading ChessPosition. Valid values are from a1 to h8."); // Tratamento
																												// do
																												// erro
																												// de
																												// entrada
	...
	private static void printPiece(ChessPiece piece, boolean background) {
		...
		if (piece == null) {
			System.out.print("-" + ANSI_RESET); // Se não houver peça, imprimir o "-"
		} else {
